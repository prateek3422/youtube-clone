...
return res.status(200).json(new ApiResponse(200, getSubscriber, "subscriber fetched successfully"))
})
...
const getSubscribedChannels = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, getChannel, "channel featched successfully"))
})
