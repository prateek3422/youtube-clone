        ...
        <div className="w-full relative  bg-grey-dark">
          ...
          <main>
            <div className="flex flex-col">
              {slide && (
                <div
                  className={`w-40 z-[999] fixed top-20   h-[100vh] bg-grey-dark left-0 overflow-hidden animate-slide-in`}
                >
              ...
              <div className={`absolute top-24 px-4 py-4 flex flex-col  ${slide ? " w-full items-end": "w-full"} `} onClick={() => setSlide(false)}>
                <Outlet  />
              </div>
            </div>
          </main>
